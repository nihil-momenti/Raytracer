...
def generateScene():
  ...
  METAL = Texture(Point3(-1,-0.6,2), # Top left point
    'metal.jpg', Vector3(0,1,0), Vector3(0,0,1), Vector3(1,0,0), # Texture file, x vector, y vector
    None, None, None) # Specular colour, shininess, reflectivity
  ...
  FocusedLight(Colour(2,2,2), Point3(-1, 1, -0.2), Point3(0, -0.6, 0.3), 20, scene)
  PointLight(Colour(1, 1, 1), Point3(0.2, 0.2, 0), scene)
